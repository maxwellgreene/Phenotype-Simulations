...
ggplot(data) + geom_line(mapping=aes(x=timestep,y=kStore)) + geom_line(mapping=aes(x=timestep,y=nReprod)) + geom_line(mapping=aes(x=timestep,y=nWorker))
```